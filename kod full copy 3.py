...
RELAY_PIN1 = 25 # โซลินอยถังเพาะ
RELAY_PIN2 = 7 # มอเตอร์ถังเพาะ
RELAY_PIN3 = 20 # มอเตอร์บำบัดน้ำ
RELAY_PIN4 = 21 # มอเตอร์ถังเก็บน้ำ โซลินอยถังเก็บน้ำ
RELAY_PIN5 = 16 # พัดลม
RELAY_PIN6 = 26 # ฮีทเตอร์
RELAY_PIN7 = 8 # มอเตอร์ถังฮอร์โมน โซลินอยถังเก็บฮอร์โมน
FLOATSWITCH_PIN1 = 17 # ลูกลอยถังน้ำ บน
FLOATSWITCH_PIN2 = 10 # ลูกลอยถังน้ำ ล่าง
...
class WateringSystem:
    ...
    def create_widgets(self):
        ...
        self.status1 = tk.Label(status_frame, text="ประเภทการทำงาน : รอทำการเพาะปลูก", font=("consolas", 21))
    ...
    def update_data(self):
        ...
        variable6 = float(values[5])
        variable7 = float(values[6])
        # variable8 = float(values[7])
        variable9 = float(values[8])
        variable10 = float(values[9])
    ...
    def manual_value(self):    
        ...
        entry_timW.insert(0, "10")
        entry_timfanW.insert(0, "20")
